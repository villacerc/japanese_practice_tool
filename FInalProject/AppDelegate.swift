...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    /*func checkOrientation(viewController: UIViewController?) -> UIInterfaceOrientationMask {
        if viewController == nil {
            return UIInterfaceOrientationMask.portrait
        } else if viewController is StrokeViewController || viewController is ReadingViewController || viewController is ViewController {
            return UIInterfaceOrientationMask.portrait
        } else if viewController is GameViewController {
